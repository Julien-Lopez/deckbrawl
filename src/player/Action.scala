...
case class NormalSummon(p: Player, c: Card) extends Action
case class PlaySpell(p: Player, c: Card) extends Action
case class SetTrap(p: Player, c: Card) extends Action
